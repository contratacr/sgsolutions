...
export function Catalogo(){
 ...
 return <>
  ...
  <MarcasDestacadas marcas={marcas} seleccionada={marca} seleccionar={nombre=>{setMarca(marca===nombre?'':nombre);setCategoria('todos');setBusqueda('');}} verTodas={()=>{setMarca('');setCategoria('todos');setBusqueda('');}}/>
